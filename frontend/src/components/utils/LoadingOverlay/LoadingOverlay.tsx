...
const LoadingOverlay: React.FC<LoaderProps> = (props: LoaderProps) => {
        ...
        {props.isLoading && (
          <div className={'modal-backdrop backdrop-blur'}>
            <div className={'modal-loader'}>
              <div className={'loader-content pt-5 pb-5'}>
                <div role='status'>
                  <svg
  ...
  return <>{ReactDOM.createPortal(loader(), document.getElementById('overlay-root')!)}</>
}

export default connect(
  (state: AppState): LoaderProps => ({
